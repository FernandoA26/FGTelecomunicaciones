...
<body class="bg-silver-300">
    <div class="content">
        <div class="brand">
            <a class="link" href="index.html">Iniciar sesi&oacute;n</a>
        </div>
        <form id="login-form" action="javascript:;" method="post">
            ...
            <div class="form-group">
                <div class="input-group-icon right">
                    ...
                    <input class="form-control" type="text" name="email" placeholder="Ingresasr usuario" autocomplete="off" id="usuario">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group-icon right">
                    <div class="input-icon"><i class="fa fa-lock font-16"></i></div>
                    <input class="form-control" type="password" name="password" placeholder="Ingresar password" id="password">
                </div>
            </div>
